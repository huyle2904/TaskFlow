...
public class UnitOfWork : IUnitOfWork
{
    ...
    private ITaskItemAssignmentRepository? _taskItemAssignments;
    ...
    public ITaskItemAssignmentRepository TaskItemAssignments => _taskItemAssignments ??= new TaskItemAssignmentRepository(_context);
